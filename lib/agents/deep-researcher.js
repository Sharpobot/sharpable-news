...
PENTING: Lakukan MAKSIMUM 3 carian web sahaja. Fokus pada sumber paling berautoriti dan terkini.
...
Return a JSON object in this exact format:
{
  ...
  if (result.raw) {
    console.log('[deep-researcher] ⚠️ JSON parse failed — raw response (first 1000 chars):')
    console.log(String(result.raw).slice(0, 1000))
  } else {
    console.log('[deep-researcher] parsed result keys:', Object.keys(result))
  }
