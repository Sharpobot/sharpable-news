...
export async function articleWriter(context = {}) {
  ...
  const WORD_COUNT_BY_LENGTH = {
    short: { instruction: '600–700 patah perkataan', target: 650 },
    standard: { instruction: '700–800 patah perkataan', target: 750 },
    long: { instruction: '850–950 patah perkataan', target: 900 },
  }
